...
class PVTModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_image_segmentation_ade(self):
        ...
        model = PVTForSemanticSegmentation.from_pretrained("nvidia/pvt-b0-finetuned-ade-512-512").to(
            torch_device
        )
    ...
    def test_inference_image_segmentation_city(self):
        ...
        model = PVTForSemanticSegmentation.from_pretrained(
            "nvidia/pvt-b1-finetuned-cityscapes-1024-1024"
        ).to(torch_device)
